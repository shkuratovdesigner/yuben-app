...
<body><div class="wrap">
  ...
  <p class="foot">Generated by YuBen · ${esc(new Date().toISOString().slice(0, 10))} · ${
    USE_MOCKS
      ? `Sample data — this export was generated from bundled demo fixtures, not a live
  research run. Video IDs, titles and channels are real; counts are representative values.`
